...
{
    public partial class TPE21_Winter_Auth_LabContext : DbContext
    {
        public TPE21_Winter_Auth_LabContext()
        {
        }

        public TPE21_Winter_Auth_LabContext(DbContextOptions<TPE21_Winter_Auth_LabContext> options)
            : base(options)
        {
        }
